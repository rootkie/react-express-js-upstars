...
class StudentForm extends Component {
  ...
  render () {
    const {
      profile, father, mother, otherFamily, misc, terms, tuitionChoices, termsDetails, error, serverError, activeItem, submitSuccess
    } = this.state
    ...
    return (
      <div style={{ 'margin': '1.5em' }}>
        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          />
          <Form.Button type='submit'>Register as a Student</Form.Button>
          <ReCAPTCHA
            ref={(el) => { captcha = el }}
            size='invisible'
