...
const PageHeader = ({ mobile }) => {
  ...
  return (
    <Container text>
      ...
      />
      <Button color='pink' size='huge' onClick={scroll}>
        Learn More&nbsp;&nbsp;
...
const MobileContainer = ({ children }) => {
  ...
  const handlePusherClick = () => {
    if (sidebarOpened) handleSidebar(false)
  }

  const handleToggle = () => {
    // Toggle true to false and vice versa
    handleSidebar(!sidebarOpened)
  }
...
const Home = () => {
  const [activeIndex, handleIndex] = useState(-1)

  const handleClick = (e, titleProps) => {
    const { index } = titleProps
    const newIndex = activeIndex === index ? -1 : index
    // Either closes it if it is opened or open another one that is previously closed and close the current one.
        ...
        <Grid container stackable verticalAlign='middle'>
          <Grid.Row>
            <Grid.Column>
              ...
              <Accordion fluid>
                <Accordion.Title active={activeIndex === 0} index={0} onClick={handleClick} style={{ fontSize: '1.5em', color: 'white' }}>
                  <Icon name='dropdown' />
                ...
                <Accordion.Title active={activeIndex === 1} index={1} onClick={handleClick} style={{ fontSize: '1.5em', color: 'white' }}>
                  <Icon name='dropdown' />
                ...
                <Accordion.Title active={activeIndex === 2} index={2} onClick={handleClick} style={{ fontSize: '1.5em', color: 'white' }}>
                  <Icon name='dropdown' />
                ...
                <Accordion.Title active={activeIndex === 3} index={3} onClick={handleClick} style={{ fontSize: '1.5em', color: 'white' }}>
                  <Icon name='dropdown' />
                ...
                <Accordion.Title active={activeIndex === 4} index={4} onClick={handleClick} style={{ fontSize: '1.5em', color: 'white' }}>
                  <Icon name='dropdown' />
